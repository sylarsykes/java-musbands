package org.sylrsykssoft.java.musbands.musbands.member.configuration;
 ...
 */
@Configuration
@EntityScan("org.sylrsykssoft.java.musbands.musbands.discographic.domain")
@ComponentScan({ 
...
@EnableJpaRepositories({ "org.sylrsykssoft.java.musbands.musbands.discographic.repository" })

...
public class DiscographicServiceTest {
	...
	public void setUp() {
		...
		domain = DiscographicResource.discographicResourceBuilder().name(name).description(description).build();
	...
	public void testUpdateDiscographic() {
		...
		DiscographicResource resourceUpdated = discographicService.save(DiscographicResource.discographicResourceBuilder().entityId(resourceGet.getEntityId()).name(resourceGet.getName())

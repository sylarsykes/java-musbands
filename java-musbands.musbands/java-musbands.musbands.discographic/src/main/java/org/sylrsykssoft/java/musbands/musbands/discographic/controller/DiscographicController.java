 ...
 *
 */
@RestController(DiscographicConstants.CONTROLLER_NAME)
@RequestMapping(DiscographicConstants.CONTROLLER_REQUEST_MAPPING)
public class DiscographicController extends BaseEntityController<DiscographicResource, Discographic> {

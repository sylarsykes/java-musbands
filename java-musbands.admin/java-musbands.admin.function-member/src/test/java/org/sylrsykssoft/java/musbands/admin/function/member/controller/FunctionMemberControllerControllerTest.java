...
//		when(FunctionMemberService.findAll()).thenReturn(Arrays.asList(new FunctionMemberResource()));
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get(FunctionMemberConstants.CONTROLLER_REQUEST_MAPPING_TEST)
	...
	public void testFindById() throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get(FunctionMemberConstants.CONTROLLER_REQUEST_MAPPING_TEST + FunctionMemberConstants.CONTROLLER_GET_FIND_BY_ID, 1);
	...
	public void testFindByName() throws Exception {
		...
		RequestBuilder requestBuilder = MockMvcRequestBuilders.get(FunctionMemberConstants.CONTROLLER_REQUEST_MAPPING_TEST + FunctionMemberConstants.CONTROLLER_GET_FIND_BY_NAME_MAPPING, "Lead guitar");
	...
	public void testFindByExample() throws Exception {
		...
		// call GET /admin/functionMembers/name/{name} application/json
		MockHttpServletRequestBuilder postBuilder = MockMvcRequestBuilders.post(FunctionMemberConstants.CONTROLLER_REQUEST_MAPPING_TEST + FunctionMemberConstants.CONTROLLER_GET_FIND_BY_EXAMPLE)
	...
	public void testFindAllByExample() throws Exception {
		...
		// call GET /admin/functionMembers/name/{name} application/json
		MockHttpServletRequestBuilder postBuilder = MockMvcRequestBuilders.post(FunctionMemberConstants.CONTROLLER_REQUEST_MAPPING_TEST + FunctionMemberConstants.CONTROLLER_GET_FIND_ALL_BY_EXAMPLE)
				.contentType(MediaType.APPLICATION_JSON_VALUE).content(asJsonString(domain));
	...
	public void testFindAllByExampleSortable() throws Exception {
		...
		MockHttpServletRequestBuilder postBuilder = MockMvcRequestBuilders.post(FunctionMemberConstants.CONTROLLER_REQUEST_MAPPING_TEST + FunctionMemberConstants.CONTROLLER_GET_FIND_ALL_BY_EXAMPLE_SORTABLE)
	...
	public void testCreateFunctionMember() throws Exception {
		...
		MockHttpServletRequestBuilder postBuilder = MockMvcRequestBuilders.post(FunctionMemberConstants.CONTROLLER_REQUEST_MAPPING_TEST)
				.contentType(MediaType.APPLICATION_JSON_VALUE).content(asJsonString(domain));
	...
	public void testUpdateFunctionMember() throws Exception {
		...
		MockHttpServletRequestBuilder putBuilder = MockMvcRequestBuilders.put(FunctionMemberConstants.CONTROLLER_REQUEST_MAPPING_TEST + FunctionMemberConstants.CONTROLLER_GET_FIND_BY_ID, 2)
	...
	public void testDeleteFunctionMember() throws Exception {
		...
		MockHttpServletRequestBuilder deleteBuilder = MockMvcRequestBuilders.delete(FunctionMemberConstants.CONTROLLER_REQUEST_MAPPING_TEST + FunctionMemberConstants.CONTROLLER_GET_FIND_BY_ID, 2);
